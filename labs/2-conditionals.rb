...
# 4. test if we won - first step
# if total == 7 || total == 11
#     puts "YOU WIN!"
# end

# 2nd step: you lose, third step: point is .-- elseif is just another statement, whereas else is if it doesn't hit if or elsif then it returns else.
if total == 7 || total == 11
    puts "YOU WIN!"
